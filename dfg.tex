...
% final version?
\setboolean{finalcompile}{false}%true}%
...
\newcommand{\applicants}{John Doe, Gotham City
...
\subsection{Added value of the French-German scientific cooperation}
...
\backmatter
\setcounter{page}{1}
\ifthenelse{\boolean{finalcompile}}{}{\ihead*{template ANR DFG 2026 NLE}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hspace{20pt} \textbf{German side – requested modules/funds (from DFG)}
...
\hspace{20pt} \textbf{French side – requested funds (from ANR)}
...
\todo{Overview of requested amounts (Table)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
